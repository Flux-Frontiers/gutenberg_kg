...
make publish-worker-image RUNTIME=apple  # amd64 (Rosetta) + arm64 image index, pushed
make pull-worker-image RUNTIME=apple     # use a published image instead of building
```
