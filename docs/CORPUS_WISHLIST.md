# GutenbergKG — Corpus Wishlist

Checklist of high-priority additions. Work in cross-genre batches — downloads are fast, ingest takes ~15 min on a fast Mac.
...
- [x] The Analects of Confucius — James Legge translation (#4094)

---

## Philosophy

- [x] Nicomachean Ethics — Aristotle (#8438)
- [x] Politics — Aristotle (#6762)
- [x] Poetics — Aristotle (#1974)
- [x] The Symposium — Plato (#1600)
- [x] Apology — Plato (#1656)
- [x] Phaedo — Plato (#1658)
...
- [x] The Social Contract — Jean-Jacques Rousseau (#46333)
- [x] The Art of War — Sun Tzu (#132)
- [x] Essays (First & Second Series) — Ralph Waldo Emerson (#2944)
- [x] The Problems of Philosophy — Bertrand Russell (#5827)
- [x] On the Duty of Civil Disobedience — Henry David Thoreau (#71)
- [x] A Vindication of the Rights of Woman — Mary Wollstonecraft (#3420)

---

## Ancient & Classical

- [x] Histories — Herodotus (#2707)
- [x] History of the Peloponnesian War — Thucydides (#7142)
- [x] Parallel Lives — Plutarch (#674)
...
- [x] Tales of Mystery and Imagination — Edgar Allan Poe (#2147)
- [x] The Raven and Other Poems — Edgar Allan Poe (#17192)
- [x] Narrative of the Life of Frederick Douglass — Frederick Douglass (#23)
...
- [x] The Legend of Sleepy Hollow — Washington Irving (#41)
- [x] The Jungle — Upton Sinclair (#140)
- [x] My Ántonia — Willa Cather (#242)
- [x] O Pioneers! — Willa Cather (#24)

---

## English Literature

- [x] Tess of the d'Urbervilles — Thomas Hardy (#110)
- [x] Far from the Madding Crowd — Thomas Hardy (#107)
...
- [x] The Mayor of Casterbridge — Thomas Hardy (#143)
- [x] Vanity Fair — William Makepeace Thackeray (#599)
- [x] David Copperfield — Charles Dickens (#766)
- [x] Bleak House — Charles Dickens (#1023)
...
- [x] Journey to the Center of the Earth — Jules Verne (#3748)
...
## Technical / Reference *(Internet Archive — needs curation)*
