...
def _gutenkg_version() -> str:
    ...
    try:
        from gutenberg_kg import __version__  # pylint: disable=import-outside-toplevel
...
def main() -> None:
    ...
    for genre in GENRE_ORDER:
        ...
        for book_dir in books:
            ...
            # Directory names are curated by this repo and are more stable than
            # occasionally noisy external metadata in reference.md.
