...
Two code paths:
  ...
  generate_auto()       — server if IMAGE_ENDPOINT / server_url set,
                          else local fallback
...
IMAGE_ENDPOINT        Base URL of a running mflux-serve instance
...
def vlm_rewrite(
    ...
    *,
    ...
    :param model: Model ID. Falls back to GUTENKG_VLM_MODEL or the Qwen3 default.
...
def generate_via_server(
    ...
    *,
    ...
    :param prompt: Text description of the image to generate.
    :param server_url: Base URL of the mflux-serve instance, e.g. http://localhost:8090.
    :param aspect_ratio: One of 1:1, 3:2, 2:3, 16:9, 9:16, 4:3, 3:4.
    :param seed: Optional integer seed for reproducibility.
    :param steps: Override inference steps (default: IMAGE_STEPS or 4).
...
def generate_auto(
    ...
    *,
    ...
    Resolution order:
      ...
      2. IMAGE_ENDPOINT environment variable
    ...
    :returns: PIL Image.
    """
    url = server_url or os.environ.get("IMAGE_ENDPOINT", "")
    if url:
